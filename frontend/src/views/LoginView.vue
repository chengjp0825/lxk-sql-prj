    ...
    <div class="relative z-10 w-full max-w-md mx-4">
      ...
      <div class="glass-strong rounded-2xl p-8">
        <div v-if="isLogin" class="space-y-5">
          ...
          <div v-if="error" class="text-sm rounded-xl px-4 py-3 border" style="color: var(--status-occupied); background: var(--status-rejected-bg); border-color: var(--status-occupied-border);">{{ error }}</div>
